    ...
    <div class="">    
        ...
        <div class="">
            ...
            <div class="input-prepend span4">
                ...
                <input type="text" placeholder="cuenta-red social que mas utiliza" name="face" value="<?php echo @set_value('red_social')?>" />
            </div>
            
            <div class="input-prepend span4">
                <span class="btn btn-primary input-small">Tel&eacute;fono</span>
                <input type="tel" pattern='\d-\d\d\d\d\d\d\d' x-moz-errormessage="Ingrese un telefono valido 'xxxxxxxx'"  name="fijo" placeholder=" Ej. 22457898"/>
            </div>
            <div class="input-prepend span4">
                <span class="btn btn-primary input-small">Celular</span> 
                <input type="tel" pattern='\d\d\d\d\d\d\d\d' x-moz-errormessage="Ingrese un telefono movil valido 'xxxxxxxx'" name="movil" required="" placeholder=" Ej. 79822222"/>
            </div>
            <div class="input-prepend span4">
                <span class="btn btn-primary input-small">Ciudad</span>
                <input type="text" name="ciudad" placeholder="La Paz, El Alto, Oruro .." required=""/>
            </div>
            <div class="input-prepend span4">
                <span class="btn btn-primary input-small">Direccion</span>
                <input type="text" name="direccion" placeholder="Z/V.fatima C/Los angeles Nro.1094" required=""/>
            </div>
            <div class="input-prepend span4">
                <span class="btn btn-primary input-small">Ocupacion</span>
                <input type="text" name="ocupacion"  placeholder="Abogado, ama de casa, etc."required=""/>
            </div>
            <div class="input-prepend span4">
